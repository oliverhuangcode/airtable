...
export const RecordFindFirstOrThrowSelectSchema: z.ZodType<Prisma.RecordSelect> = z.object({
...
export const RecordFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    tableId: z.boolean().optional(),
    table: z.boolean().optional(),
    order: z.boolean().optional(),
...
export const RecordFindFirstOrThrowSchema: z.ZodType<Prisma.RecordFindFirstOrThrowArgs> = z.object({ select: RecordFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => RecordIncludeObjectSchema.optional()), orderBy: z.union([RecordOrderByWithRelationInputObjectSchema, RecordOrderByWithRelationInputObjectSchema.array()]).optional(), where: RecordWhereInputObjectSchema.optional(), cursor: RecordWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RecordScalarFieldEnumSchema, RecordScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.RecordFindFirstOrThrowArgs>;

export const RecordFindFirstOrThrowZodSchema = z.object({ select: RecordFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => RecordIncludeObjectSchema.optional()), orderBy: z.union([RecordOrderByWithRelationInputObjectSchema, RecordOrderByWithRelationInputObjectSchema.array()]).optional(), where: RecordWhereInputObjectSchema.optional(), cursor: RecordWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RecordScalarFieldEnumSchema, RecordScalarFieldEnumSchema.array()]).optional() }).strict();