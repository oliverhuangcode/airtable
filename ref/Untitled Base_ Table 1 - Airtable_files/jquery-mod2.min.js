...
!(function (e, t) {
  ...
  ((d.fn = d.prototype =
    ...
    d.extend({
      ...
      each: function (e, t, n) {
        ...
        if (n) {
          if (s) {
            for (; i < o; i++) if (!1 === (r = t.apply(e[i], n))) break;
          } else for (i in e) if (!1 === (r = t.apply(e[i], n))) break;
        } else if (s) {
          for (; i < o; i++) if (!1 === (r = t.call(e[i], i, e[i]))) break;
      ...
      map: function (e, t, n) {
        var r,
          ...
          a,
          u = [];
        if (y(e)) for (; o < s; o++) null != (r = t(e[o], o, n)) && u.push(r);
        else for (o in e) null != (r = t(e[o], o, n)) && u.push(r);
        return i.apply([], u);
      },
      guid: 1,
      proxy: function (e, t) {
  ...
  var x = (function (e) {
        ...
        if (11 !== c && (o = Z.exec(e)))
          if ((l = o[1])) {
            ...
            if ((l = o[3]) && n.getElementsByClassName)
              return (H.apply(r, t.getElementsByClassName(l)), r);
          }
        if (n.qsa && (!m || !m.test(e))) {
          if (
            ((y = v = w),
              ...
              ? function (e, t) {
                  ...
                  return (
                    ...
                    (!n.sortDetached && t.compareDocumentPosition(e) === r)
                      ? e === s || (e.ownerDocument === b && x(b, e))
                        ? -1
                        : t === s || (t.ownerDocument === b && x(b, t))
                          ? 1
                          : c
                            ? F(c, e) - F(c, t)
                            : 0
      ...
      return (
        ...
        ae(function (o, s, a, u) {
          var l,
            ...
            v = n ? (i || (o ? e : h || r) ? [] : s) : m;
          if ((n && n(m, v, a, u), r)) {
            ((l = we(v, d)), r(l, [], a, u), (c = l.length));
            while (c--) (f = l[c]) && (v[d[c]] = !(m[d[c]] = f));
          }
          if (o) {
            if (i || e) {
              if (i) {
    ...
    function Te(e) {
      for (
        ...
        if ((n = r.relative[e[u].type])) p = [ve(ye(p), n)];
        else {
      ...
      var n = t.length > 0,
        ...
        o = function (o, s, a, u, c) {
          var f,
            ...
            x = l,
            w = o || (i && r.find.TAG("*", c)),
            b = (T += null == x ? 1 : Math.random() || 0.1),
            C = w.length;
          for (c && (l = s !== d && s); m !== C && null != (f = w[m]); m++) {
            if (i && f) {
              p = 0;
              while ((h = e[p++]))
                if (h(f, s, a)) {
    ...
    return (
      ...
      (a = oe.compile =
        function (e, t) {
          ...
          if (!o) {
            (t || (t = s(e)), (n = t.length));
            while (n--) (o = Te(t[n]))[w] ? r.push(o) : i.push(o);
      ...
      (u = oe.select =
        function (e, t, i, o) {
            ...
            while (u--) {
              ...
              if (
                ...
                (o = p(
                  ...
                  (ee.test(l[0].type) && he(t.parentNode)) || t,
                ))
              ) {
          ...
          return (
            (d || a(e, h))(o, t, !g, i, (ee.test(e) && he(t.parentNode)) || t),
            i
          );
        }),
  ...
  ((d.filter = function (e, t, n) {
    ...
    d.fn.extend({
      ...
      is: function (e) {
        return !!C(this, "string" == typeof e && w.test(e) ? d(e) : e || [], !1)
          .length;
      },
    }));
  var k,
      ...
      function (e, t) {
        d.fn[e] = function (n, r) {
          ...
          return (
            ...
            this.length > 1 && (D[e] || d.unique(i), S.test(e) && i.reverse()),
            this.pushStack(i)
          );
        };
      },
  ...
  ((d.Callbacks = function (e) {
    ...
    d.extend({
      ...
      when: function (e) {
        var t = 0,
          n = r.call(arguments),
          i = n.length,
          o = 1 !== i || (e && d.isFunction(e.promise)) ? i : 0,
          s = 1 === o ? e : d.Deferred(),
          a = function (e, t, n) {
            return function (i) {
              ((t[e] = this),
                (n[e] = arguments.length > 1 ? r.call(arguments) : i),
                n === u ? s.notifyWith(t, n) : --o || s.resolveWith(t, n));
            };
          },
          u,
          l,
          c;
        if (i > 1)
          for (u = new Array(i), l = new Array(i), c = new Array(i); t < i; t++)
            n[t] && d.isFunction(n[t].promise)
              ? n[t]
                  .promise()
                  .done(a(t, c, n))
                  .fail(s.reject)
                  .progress(a(t, l, u))
              : --o;
        return (o || s.resolveWith(c, n), s.promise());
      },
    }),
    ...
    d.ready.promise());
  var F = (d.access = function (e, t, n, r, i, o, s) {
    var a = 0,
      u = e.length,
      l = null == n;
    if ("object" === d.type(n))
  ...
  function I(e, t, n) {
    ...
    if (void 0 === n && 1 === e.nodeType)
      if (
        ((r = "data-" + t.replace($, "-$1").toLowerCase()),
    ...
    d.fn.extend({
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((i = M.get(o)), 1 === o.nodeType && !R.get(o, "hasDataAttrs"))
          ) {
            n = s.length;
            while (n--)
              s[n] &&
                0 === (r = s[n].name).indexOf("data-") &&
                ((r = d.camelCase(r.slice(5))), I(o, r, i[r]));
          ...
          : F(
              ...
              function (t) {
                var n,
                  r = d.camelCase(e);
                if (o && void 0 === t)
                  return void 0 !== (n = M.get(o, e)) ||
                    void 0 !== (n = M.get(o, r)) ||
                    void 0 !== (n = I(o, r, void 0))
                    ? n
                    : void 0;
                this.each(function () {
                  var n = M.get(this, r);
  ...
  var B = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
    ...
    V,
    Y;
  ((V = f.createDocumentFragment().appendChild(f.createElement("div"))),
    (Y = f.createElement("input")).setAttribute("type", "radio"),
    Y.setAttribute("checked", "checked"),
    Y.setAttribute("name", "t"),
    V.appendChild(Y),
    (c.checkClone = V.cloneNode(!0).cloneNode(!0).lastChild.checked),
    (V.innerHTML = "<textarea>x</textarea>"),
    (c.noCloneChecked = !!V.cloneNode(!0).lastChild.defaultValue));
  var G = "undefined";
  ...
  ((d.event = {
      ...
      if (v) {
        (n.handler && ((n = (o = n).handler), (i = o.selector)),
          ...
          (s = v.handle) ||
            (s = v.handle =
              function (t) {
                return typeof d !== G && d.event.triggered !== t.type
    ...
    remove: function (e, t, n, r, i) {
      ...
      if (v && (u = v.events)) {
        ...
        d.isEmptyObject(u) && (delete v.handle, R.remove(e, "events"));
      }
    },
    trigger: function (t, n, r, i) {
      ...
      if (
        ...
        if (!i && !h.noBubble && !d.isWindow(r)) {
          for (
            u = h.delegateType || m, K.test(u + m) || (s = s.parentNode);
            s;
            s = s.parentNode
          )
            (g.push(s), (a = s));
    ...
    fix: function (e) {
      ...
      (s ||
        (this.fixHooks[i] = s =
          J.test(i) ? this.mouseHooks : Q.test(i) ? this.keyHooks : {}),
    ...
    d.extend({
      clone: function (e, t, n) {
        ...
        if (
          ...
          for (s = me(a), r = 0, i = (o = me(e)).length; r < i; r++)
            ve(o[r], s[r]);
        if (t)
          if (n)
            for (
        ...
        return (
          (s = me(a, "script")).length > 0 && he(s, !u && me(e, "script")),
          a
        );
      },
      buildFragment: function (e, t, n, r) {
        ...
        while ((i = f[p++]))
          if (
            ...
            l = 0;
            while ((i = o[l++])) ae.test(i.type || "") && n.push(i);
          }
        return c;
      },
      cleanData: function (e) {
        for (
          ...
          if (d.acceptData(n) && (i = n[R.expando]) && (t = R.cache[i])) {
            if (t.events)
              for (r in t.events)
    ...
    d.fn.extend({
      ...
      remove: function (e, t) {
        for (
          ...
          (t || 1 !== n.nodeType || d.cleanData(me(n)),
            n.parentNode &&
              (t && d.contains(n.ownerDocument, n) && he(me(n, "script")),
              n.parentNode.removeChild(n)));
        return this;
      },
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++)
          1 === e.nodeType && (d.cleanData(me(e, !1)), (e.textContent = ""));
        return this;
      },
      clone: function (e, t) {
        return (
        ...
        return F(
          ...
          function (e) {
            ...
            if (
              "string" == typeof e &&
              !oe.test(e) &&
              !ce[(re.exec(e) || ["", ""])[1].toLowerCase()]
            )
              try {
                for (; n < r; n++)
                  1 === (t = this[n] || {}).nodeType &&
                    (d.cleanData(me(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (e) {}
      ...
      domManip: function (e, t) {
        ...
        var n,
          ...
          g = e[0],
          m = d.isFunction(g);
        if (m || (f > 1 && "string" == typeof g && !c.checkClone && se.test(g)))
        ...
        if (
          ...
          for (s = (o = d.map(me(n, "script"), pe)).length; l < f; l++)
            ((a = n),
              l !== h &&
                ((a = d.clone(a, !0, !0)), s && d.merge(o, me(a, "script"))),
              t.call(this[l], a, l));
          if (s)
            for (
              u = o[o.length - 1].ownerDocument, d.map(o, de), l = 0;
              l < s;
              l++
            )
              ((a = o[l]),
                ae.test(a.type || "") &&
                  !R.access(a, "globalEval") &&
                  d.contains(u, a) &&
                  (a.src
                    ? d._evalUrl && d._evalUrl(a.src)
                    : d.globalEval(a.textContent.replace(le, ""))));
        }
        return this;
      },
    }),
  ...
  function be(e) {
    ...
    return (
      n ||
        (("none" !== (n = we(e, t)) && n) ||
          ((t = (ye = (
            ye || d("<iframe frameborder='0' width='0' height='0'/>")
  ...
  function He(e, t) {
    ...
    var n = t[0].toUpperCase() + t.slice(1),
      r = t,
      i = qe.length;
    while (i--) if ((t = qe[i] + n) in e) return t;
    return r;
  }
  function Oe(e, t, n) {
    var r = De.exec(t);
      ...
      (r = e[s]).style &&
        ...
        t
          ? (o[s] || "none" !== n || (r.style.display = ""),
            "" === r.style.display &&
              z(r) &&
              (o[s] = R.access(r, "olddisplay", be(r.nodeName))))
          : ((i = z(r)),
            ("none" === n && i) ||
  ...
  (d.extend({
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          u = e.style;
        if (
          ((t = d.cssProps[a] || (d.cssProps[a] = He(u, a))),
    ...
    css: function (e, t, n, r) {
      var i,
        ...
        a = d.camelCase(t);
      return (
        (t = d.cssProps[a] || (d.cssProps[a] = He(e.style, a))),
        (s = d.cssHooks[t] || d.cssHooks[a]) &&
          "get" in s &&
          (i = s.get(e, !0, n)),
        void 0 === i && (i = Ne(e, t, r)),
    ...
    d.each(["height", "width"], function (e, t) {
      d.cssHooks[t] = {
        get: function (e, n, r) {
          if (n)
            return Se.test(d.css(e, "display")) && 0 === e.offsetWidth
              ? d.swap(e, Ae, function () {
                  return Pe(e, t, r);
                })
              : Pe(e, t, r);
        },
        set: function (e, n, r) {
          ...
          return Oe(
            ...
            n,
            r
              ? Fe(e, t, r, "border-box" === d.css(e, "boxSizing", !1, i), i)
              : 0,
          );
        },
      };
    }),
    (d.cssHooks.marginRight = Ee(c.reliableMarginRight, function (e, t) {
      if (t)
        return d.swap(e, { display: "inline-block" }, Ne, [e, "marginRight"]);
    })),
    d.each({ margin: "", padding: "", border: "Width" }, function (e, t) {
      ((d.cssHooks[e + t] = {
        ...
        Te.test(e) || (d.cssHooks[e + t].set = Oe));
    }),
    d.fn.extend({
      css: function (e, t) {
        return F(
  ...
  function Ge(e, t, n) {
      ...
      "inline" ===
        (c =
          "none" === (l = d.css(e, "display"))
            ? R.get(e, "olddisplay") || be(e.nodeName)
            : l) &&
        "none" === d.css(e, "float") &&
    ...
    if (d.isEmptyObject(p))
      "inline" === ("none" === l ? be(e.nodeName) : l) && (h.display = l);
    else
      for (r in (m
  ...
  function Je(e, t, n) {
    var r,
      ...
      c = l.props;
    for (Qe(c, l.opts.specialEasing); o < s; o++)
  ...
  ((d.Animation = d.extend(Je, {
      ...
      stop: function (e, t, n) {
        ...
        return (
          ...
          this.each(function () {
            ...
            else for (i in s) s[i] && s[i].stop && _e.test(i) && r(s[i]);
            for (i = o.length; i--; )
              o[i].elem !== this ||
                (null != e && o[i].queue !== e) ||
    ...
    (d.fx.interval = 13),
    (d.fx.start = function () {
      $e || ($e = setInterval(d.fx.tick, d.fx.interval));
    }),
    (d.fx.stop = function () {
      ...
      attr: function (e, t, n) {
        ...
        if (e && 3 !== o && 8 !== o && 2 !== o)
          return typeof e.getAttribute === G
            ...
            : ((1 === o && d.isXMLDoc(e)) ||
                ((t = t.toLowerCase()),
                (r = d.attrHooks[t] || (d.expr.match.bool.test(t) ? Ze : Ke))),
              void 0 === n
  ...
  (d.fn.extend({
    ...
    d.extend({
      ...
      propHooks: {
        tabIndex: {
          get: function (e) {
            return e.hasAttribute("tabindex") || tt.test(e.nodeName) || e.href
              ? e.tabIndex
              : -1;
          },
        },
  ...
  d.fn.extend({
      ...
      if (a)
        for (t = (e || "").match(A) || []; u < l; u++)
          if (
            (r =
              1 === (n = this[u]).nodeType &&
              (n.className ? (" " + n.className + " ").replace(nt, " ") : " "))
          ) {
            o = 0;
    ...
    hasClass: function (e) {
      for (var t = " " + e + " ", n = 0, r = this.length; n < r; n++)
        if (
          1 === this[n].nodeType &&
          (" " + this[n].className + " ").replace(nt, " ").indexOf(t) >= 0
        )
          return !0;
      return !1;
    },
  ...
  (d.extend({
    ...
    ajax: function (e, t) {
        ...
        b = {
          ...
          getResponseHeader: function (e) {
            ...
            if (2 === x) {
              if (!o) {
                o = {};
                while ((t = ut.exec(i))) o[t[1].toLowerCase()] = t[2];
              }
              t = o[e.toLowerCase()];
            }
      ...
      c.hasContent ||
        (c.data &&
          ((r = c.url += (ot.test(r) ? "&" : "?") + c.data), delete c.data),
        !1 === c.cache &&
          (c.url = at.test(r)
            ? r.replace(at, "$1_=" + it++)
            : r + (ot.test(r) ? "&" : "?") + "_=" + it++)),
      c.ifModified &&
        (d.lastModified[r] &&
          b.setRequestHeader("If-Modified-Since", d.lastModified[r]),
        d.etag[r] && b.setRequestHeader("If-None-Match", d.etag[r])),
      ...
      b.setRequestHeader(
        ...
        c.dataTypes[0] && c.accepts[c.dataTypes[0]]
          ? c.accepts[c.dataTypes[0]] +
              ("*" !== c.dataTypes[0] ? ", " + gt + "; q=0.01" : "")
          : c.accepts["*"],
      ),
      c.headers))
        b.setRequestHeader(l, c.headers[l]);
      if (c.beforeSend && (!1 === c.beforeSend.call(f, b, c) || 2 === x))
        return b.abort();
      for (l in ((w = "abort"), { success: 1, error: 1, complete: 1 }))
        b[l](c[l]);
      if ((n = xt(ht, c, t, b))) {
        ((b.readyState = 1),
          ...
          l
            ? (c.ifModified &&
                ((T = b.getResponseHeader("Last-Modified")) &&
                  (d.lastModified[r] = T),
                (T = b.getResponseHeader("etag")) && (d.etag[r] = T)),
              204 === e || "HEAD" === c.type
                ? (C = "nocontent")
                : 304 === e
                  ? (C = "notmodified")
                  : ((C = w.state), (v = w.data), (l = !(y = w.error))))
            : ((y = C), (!e && C) || ((C = "error"), e < 0 && (e = 0))),
          (b.status = e),
          (b.statusText = (t || C) + ""),
          l ? h.resolveWith(f, [v, C, b]) : h.rejectWith(f, [b, C, y]),
          b.statusCode(m),
          (m = void 0),
          u && p.trigger(l ? "ajaxSuccess" : "ajaxError", [b, c, l ? v : y]),
          g.fireWith(f, [b, C]),
          u &&
            (p.trigger("ajaxComplete", [b, c]),
  ...
  ((d.offset = {
    ...
    d.fn.extend({
      offset: function (e) {
        ...
        return o
          ? ((t = o.documentElement),
            d.contains(t, r)
              ? (typeof r.getBoundingClientRect !== G &&
    ...
    d.each(["top", "left"], function (e, t) {
      d.cssHooks[t] = Ee(c.pixelPosition, function (e, n) {
        if (n)
          return ((n = Ne(e, t)), Ce.test(n) ? d(e).position()[t] + "px" : n);
      });
    }),
  ...
  return (
    (d.noConflict = function (t) {
      return (
        e.$ === d && (e.$ = Wt),
        t && e.jQuery === d && (e.jQuery = Mt),
        d
      );
    }),
    typeof t === G && (e.jQuery = e.$ = d),
    d
  );
});
