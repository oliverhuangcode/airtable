/*! jQuery UI - v1.11.4 - 2015-07-14 | http://jqueryui.com | Includes: core.js, widget.js, mouse.js, position.js, draggable.js, resizable.js, sortable.js, autocomplete.js, button.js, datepicker.js, dialog.js, menu.js, selectmenu.js, tooltip.js | Copyright 2015 jQuery Foundation and other contributors; Licensed MIT */
!(function (t) {
  ...
  ((t.cleanData = (function (e) {
    ...
    (t.widget.extend = function (e) {
      for (var i = h.call(arguments, 1), s = 0, n = i.length, o, r; s < n; s++)
        for (o in i[s])
          ((r = i[s][o]),
            i[s].hasOwnProperty(o) &&
              void 0 !== r &&
              (t.isPlainObject(r)
                ? (e[o] = t.isPlainObject(e[o])
                    ? t.widget.extend({}, e[o], r)
                    : t.widget.extend({}, r))
                : (e[o] = r)));
      return e;
    }),
  ...
  !(function () {
    ...
    ((t.position = {
        ...
        return (
          ...
          t.each(["my", "at"], function () {
            ...
            (1 === t.length &&
              ...
              (t[1] = a.test(t[1]) ? t[1] : "center"),
              (i = h.exec(t[0])),
              (s = h.exec(t[1])),
              (P[this] = [i ? i[0] : 0, s ? s[0] : 0]),
              (e[this] = [l.exec(t[0])[0], l.exec(t[1])[0]]));
          }),
          1 === C.length && (C[1] = C[0]),
          "right" === e.at[0]
            ? (_.left += m)
            : "center" === e.at[0] && (_.left += m / 2),
          "bottom" === e.at[1]
            ? (_.top += g)
          ...
          this.each(function () {
            var r,
              ...
              f = d(this, "marginLeft"),
              b = d(this, "marginTop"),
              z = l + f + d(this, "marginRight") + x.width,
              T = c + b + d(this, "marginBottom") + x.height,
              I = t.extend({}, _),
              k = p(P.my, h.outerWidth(), h.outerHeight());
            ("right" === e.my[0]
              ? (I.left -= l)
              : "center" === e.my[0] && (I.left -= l / 2),
              "bottom" === e.my[1]
                ? (I.top -= c)
                : "center" === e.my[1] && (I.top -= c / 2),
              (I.left += k[0]),
              (I.top += k[1]),
              i || ((I.left = o(I.left)), (I.top = o(I.top))),
              (r = { marginLeft: f, marginTop: b }),
              t.each(["left", "top"], function (i, s) {
                t.ui.position[C[i]] &&
                  t.ui.position[C[i]][s](I, {
                    targetWidth: m,
                    targetHeight: g,
                    elemWidth: l,
                    elemHeight: c,
              ...
              e.using &&
                (a = function (t) {
                  ...
                  (m < l && n(i + o) < m && (u.horizontal = "center"),
                    g < c && n(r + a) < g && (u.vertical = "middle"),
                    s(n(i), n(o)) > s(n(r), n(a))
                      ? (u.important = "horizontal")
                      : (u.important = "vertical"),
                    e.using.call(this, t, u));
                }),
              h.offset(t.extend(I, { using: a })));
          })
        );
      }),
      (t.ui.position = {
        fit: {
          left: function (t, e) {
            ...
            e.collisionWidth > o
              ? a > 0 && h <= 0
                ? ((l = t.left + a + e.collisionWidth - o - n),
                  (t.left += a - l))
                : (t.left =
                    h > 0 && a <= 0 ? n : a > h ? n + o - e.collisionWidth : n)
              : a > 0
                ? (t.left += a)
                : h > 0
                  ? (t.left -= h)
          ...
          top: function (t, e) {
            ...
            e.collisionHeight > o
              ? a > 0 && h <= 0
                ? ((l = t.top + a + e.collisionHeight - o - n),
                  (t.top += a - l))
                : (t.top =
                    h > 0 && a <= 0 ? n : a > h ? n + o - e.collisionHeight : n)
              : a > 0
                ? (t.top += a)
                : h > 0
                  ? (t.top -= h)
        ...
        flip: {
          left: function (t, e) {
            var i = e.within,
              ...
              f;
            h < 0
              ? ((d = t.left + u + c + p + e.collisionWidth - o - s) < 0 ||
                  d < n(h)) &&
                (t.left += u + c + p)
              : l > 0 &&
                ((f = t.left - e.collisionPosition.marginLeft + u + c + p - r) >
                  0 ||
                  n(f) < l) &&
                (t.left += u + c + p);
          },
          top: function (t, e) {
            var i = e.within,
              ...
              m;
            h < 0
              ? ((m = t.top + c + p + d + e.collisionHeight - o - s) < 0 ||
                  m < n(h)) &&
                (t.top += c + p + d)
              : l > 0 &&
                ((f = t.top - e.collisionPosition.marginTop + c + p + d - r) >
                  0 ||
                  n(f) < l) &&
                (t.top += c + p + d);
          },
      ...
      (function () {
        ...
        for (r in ((e = document.createElement(a ? "div" : "body")),
        (n = {
          visibility: "hidden",
          width: 0,
          height: 0,
        ...
        n))
          e.style[r] = n[r];
        (e.appendChild(h),
          (s = a || document.documentElement).insertBefore(e, s.firstChild),
    ...
    t.ui.plugin.add("draggable", "snap", {
      ...
      drag: function (e, i, s) {
        ...
        for (p = s.snapElements.length - 1; p >= 0; p--)
          ((l =
            (h = s.snapElements[p].left - s.margins.left) +
            s.snapElements[p].width),
            (c =
              (u = s.snapElements[p].top - s.margins.top) +
            ...
            _ > c + m ||
            !t.contains(
              s.snapElements[p].item.ownerDocument,
              s.snapElements[p].item,
            )
              ? (s.snapElements[p].snapping &&
                  s.options.snap.release &&
                  s.options.snap.release.call(
                    s.element,
                    e,
                    t.extend(s._uiHash(), { snapItem: s.snapElements[p].item }),
                  ),
                (s.snapElements[p].snapping = !1))
              : ("inner" !== f.snapMode &&
                  ((n = Math.abs(u - b) <= m),
                  (o = Math.abs(c - _) <= m),
                  (r = Math.abs(h - v) <= m),
  ...
  (t.widget("ui.resizable", t.ui.mouse, {
    ...
    _mouseStop: function (e) {
      ...
      return (
        this._helper &&
          ...
          (r = { width: u.helper.width() - o, height: u.helper.height() - n }),
          (a =
    ...
    t.ui.plugin.add("resizable", "containment", {
        ...
        p &&
          ...
          /document/.test(c) || c === document
            ...
            : ((e = t(p)),
              ...
              (a = h._hasScroll(p) ? p.scrollHeight : n),
              (h.parentData = {
                element: p,
                left: s.left,
                top: s.top,
      ...
      resize: function (e) {
        var i,
          ...
          d = !0;
        (p[0] !== document && /static/.test(p.css("position")) && (c = h),
          ...
          (i = Math.abs(
            r.sizeDiff.width +
              (r._helper ? r.offset.left - c.left : r.offset.left - h.left),
          )),
          (s = Math.abs(
            r.sizeDiff.height +
    ...
    t.ui.plugin.add("resizable", "alsoResize", {
      start: function () {
        var e,
          i = t(this).resizable("instance").options;
    ...
    t.ui.plugin.add("resizable", "grid", {
      resize: function () {
        var e,
          ...
          p = Math.round((n.height - o.height) / u) * u,
          d = o.width + c,
          f = o.height + p,
            ...
            : /^(ne)$/.test(a)
              ...
              : /^(sw)$/.test(a)
                ...
                : ((f - u <= 0 || d - l <= 0) &&
                  ...
                  d - l > 0
                    ? ((i.size.width = d), (i.position.left = r.left - c))
                    : ((d = l - e.width),
                      (i.size.width = d),
                      (i.position.left = r.left + o.width - d))));
      },
    }));
  var f = t.ui.resizable,
    m = t.widget("ui.sortable", t.ui.mouse, {
      version: "1.11.4",
      ...
      _intersectsWith: function (t) {
        var e = this.positionAbs.left,
          ...
          c = "x" === this.options.axis || (s + l > a && s + l < h),
      ...
      _refreshItems: function (e) {
        ...
        if (p && this.ready)
          for (i = p.length - 1; i >= 0; i--)
            for (s = (n = t(p[i], this.document[0])).length - 1; s >= 0; s--)
              (o = t.data(n[s], this.widgetFullName)) &&
                o !== this &&
                !o.options.disabled &&
                (c.push([
        ...
        for (i = c.length - 1; i >= 0; i--)
          for (r = c[i][1], s = 0, l = (a = c[i][0]).length; s < l; s++)
        ...
        if (p)
          if (1 === this.containers.length)
            ...
            for (
              n = 1e4,
                o = null,
                r = (u = p.floating || this._isFloating(this.currentItem))
                  ? "left"
                  : "top",
                a = u ? "width" : "height",
                c = u ? "clientX" : "clientY",
    ...
    g = t.widget("ui.menu", {
      ...
      refresh: function () {
        ...
        (this.element.toggleClass(
          ...
          (i = (e = o.add(this.element)).find(this.options.items))
            .not(".ui-menu-item")
            .each(function () {
              var e = t(this);
              s._isDivider(e) &&
  ...
  (t.widget("ui.button", {
      ...
      (null === i.label &&
        ...
        this.buttonElement
          ...
          .bind("mouseenter" + this.eventNamespace, function () {
            i.disabled || (this === _ && t(this).addClass("ui-state-active"));
          })
    ...
    _destroy: function () {
      (this.element.removeClass("ui-helper-hidden-accessible"),
        this.buttonElement
          .removeClass(b + " ui-state-active " + y)
          .removeAttr("role")
    ...
    _resetButton: function () {
      if ("input" !== this.type) {
        var e = this.buttonElement.removeClass(y),
    ...
    P = t.widget("ui.dialog", {
      ...
      _setOption: function (e, i) {
        var s,
          ...
          o = this.uiDialog;
        ("dialogClass" === e &&
          o.removeClass(this.options.dialogClass).addClass(i),
          "disabled" !== e &&
            (this._super(e, i),
      ...
      _allowInteraction: function (e) {
        if (t(e.target).closest(".ui-dialog").length) return !0;
      },
          ...
          e &&
            ...
            s.parents().each(function () {
              ...
              (e.data("ui-tooltip-open") &&
                (((s = t.Event("blur")).target = s.currentTarget = this),
                i.close(s, !0)),
                e.attr("title") &&
                  (e.uniqueId(),
                  (i.parents[this.id] = {
        ...
        s &&
          ((n = this._find(i))
            ...
            : (i.is("[title]") &&
              ...
              this.liveRegion.children().hide(),
              s.clone
                ? (a = s.clone()).removeAttr("id").find("[id]").removeAttr("id")
                : (a = s),
              ...
              this.options.show &&
                ...
                (r = this.delayedShow =
                  setInterval(function () {
                    o.is(":visible") && (l(h.of), clearInterval(r));
                  }, t.fx.interval)),
  ...
  t.ui &&
    t.ui.tooltip &&
    t.extend(t.ui.tooltip.prototype.options, {
      show: { duration: 200 },
      hide: { duration: 50 },
    });
});
