...
function ShortRowIcon({ active }: { active?: boolean }) {
  ...
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
      <path d="M2 6h14M2 9h14M2 12h14" stroke={c} strokeWidth="1.3" strokeLinecap="round" />
    </svg>
  );
}
function MediumRowIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
      <path d="M2 4.5h14M2 9h14M2 13.5h14" stroke="#666" strokeWidth="1.3" strokeLinecap="round" />
    </svg>
  );
}
function TallRowIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
      <path d="M2 3h14M2 9h14M2 15h14" stroke="#666" strokeWidth="1.3" strokeLinecap="round" />
    </svg>
  );
}
function ExtraTallRowIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
      <path d="M2 2h14M2 10h14" stroke="#666" strokeWidth="1.3" strokeLinecap="round" />
    </svg>
  );
}
function WrapHeadersIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
      <path d="M3 4h12M3 8h8M3 12h10" stroke="#666" strokeWidth="1.3" strokeLinecap="round" />
      <path d="M14 7v4l-2-2" stroke="#666" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function CheckCircleIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
      ...
      <path d="M5.5 9l2.5 2.5L12.5 7" stroke="#666" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function SlidersIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
      <path d="M3 5h12M3 9h12M3 13h12" stroke="#666" strokeWidth="1.3" strokeLinecap="round" />
      <circle cx="6" cy="5" r="1.5" fill="white" stroke="#666" strokeWidth="1.2" />
      <circle cx="12" cy="9" r="1.5" fill="white" stroke="#666" strokeWidth="1.2" />
      <circle cx="8" cy="13" r="1.5" fill="white" stroke="#666" strokeWidth="1.2" />
    </svg>
  );
}
...
function GridViewMenu({ onClose }: { onClose: () => void }) {
  return (
    <>
      ...
      <div className="absolute left-0 top-full z-50 mt-1 w-[280px] rounded-lg border border-[#e0e0e0] bg-white py-1.5 shadow-[0_4px_16px_rgba(0,0,0,0.12)]">
        <button className="flex w-full items-center gap-3 px-4 py-2.5 text-[14px] text-[#1d1f25] hover:bg-[#f5f5f5]">
          ...
          <div className="flex flex-1 flex-col items-start">
            ...
            <span className="text-[11px] text-[#888]">Editors and up can edit the view configuration</span>
          </div>
        </button>
...
function GroupByPanel({ onClose }: { onClose: () => void }) {
  return (
    <>
      <div className="fixed inset-0 z-50" onClick={onClose} />
      <div className="absolute right-0 top-full z-50 mt-1 w-[280px] rounded-lg border border-[#e0e0e0] bg-white py-1.5 shadow-[0_4px_16px_rgba(0,0,0,0.12)]">
        <div className="flex items-center justify-between px-4 py-2.5">
          <span className="text-[14px] font-semibold text-[#1d1f25]">Group by</span>
          <HelpCircle className="h-4 w-4 text-[#999]" />
        </div>
        <div className="mx-3 border-t border-[#e8e8e8]" />
        <div className="px-4 pb-1 pt-2.5 text-[12px] text-[#888]">Pick a field to group by</div>
        <button className="flex w-full items-center gap-3 px-4 py-2.5 text-[14px] text-[#1d1f25] hover:bg-[#f5f5f5]">
          <CheckCircleIcon />
          Status
        </button>
...
function ColorPanel({ onClose }: { onClose: () => void }) {
  return (
    <>
      <div className="fixed inset-0 z-50" onClick={onClose} />
      <div className="absolute right-0 top-full z-50 mt-1 w-[320px] rounded-lg border border-[#e0e0e0] bg-white py-1.5 shadow-[0_4px_16px_rgba(0,0,0,0.12)]">
        <button className="flex w-full items-center gap-3 px-4 py-3 text-left hover:bg-[#f5f5f5]">
          <CheckCircleIcon />
          <div className="flex flex-col">
            <span className="text-[14px] font-medium text-[#1d1f25]">Select field</span>
            <span className="text-[12px] text-[#888]">Color records the same as a single select field</span>
          </div>
        </button>
        <div className="mx-3 border-t border-[#e8e8e8]" />
        <button className="flex w-full items-center gap-3 px-4 py-3 text-left hover:bg-[#f5f5f5]">
          <SlidersIcon />
          <div className="flex flex-col">
            <span className="text-[14px] font-medium text-[#1d1f25]">Conditions</span>
            <span className="text-[12px] text-[#888]">Color records based on conditions</span>
          </div>
        </button>
      </div>
    </>
  ...
  return (
    <>
      ...
      <div className="absolute right-0 top-full z-50 mt-1 w-[220px] rounded-lg border border-[#e0e0e0] bg-white py-1.5 shadow-[0_4px_16px_rgba(0,0,0,0.12)]">
        <div className="px-4 py-2 text-[12px] text-[#888]">Select a row height</div>
        {(
          [
            { key: "short", label: "Short", icon: <ShortRowIcon active={selected === "short"} /> },
            { key: "medium", label: "Medium", icon: <MediumRowIcon /> },
            { key: "tall", label: "Tall", icon: <TallRowIcon /> },
            { key: "extra-tall", label: "Extra Tall", icon: <ExtraTallRowIcon /> },
          ] as const
        ).map((opt) => (
          <button
            key={opt.key}
        ...
        >
          ...
          {wrapHeaders && (
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" className="ml-auto">
              <path d="M2 7l3.5 3.5L12 4" stroke="#2d7ff9" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          )}
        </button>
      </div>
...
function ToolsExtensionsIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
      <rect x="2" y="2" width="6" height="6" rx="1.5" stroke="#666" strokeWidth="1.3" fill="none" />
      <rect x="10" y="2" width="6" height="6" rx="1.5" stroke="#666" strokeWidth="1.3" fill="none" />
      <rect x="2" y="10" width="6" height="6" rx="1.5" stroke="#666" strokeWidth="1.3" fill="none" />
      <rect x="10" y="10" width="6" height="6" rx="1.5" stroke="#666" strokeWidth="1.3" fill="none" />
    </svg>
  );
}
function ToolsManageFieldsIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
      <text x="9" y="14" textAnchor="middle" fill="#666" fontSize="13" fontWeight="700" fontFamily="sans-serif">A</text>
    </svg>
  );
}
function ToolsDocIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
      <rect x="3" y="1.5" width="12" height="15" rx="2" stroke="#666" strokeWidth="1.3" fill="none" />
      <path d="M6 5.5h6M6 9h6M6 12.5h4" stroke="#666" strokeWidth="1.2" strokeLinecap="round" />
    </svg>
  );
}
function ToolsSwapIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
      <path d="M4 6h10M14 6l-3-3M14 6l-3 3" stroke="#666" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M14 12H4M4 12l3-3M4 12l3 3" stroke="#666" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
    ...
    <>
      ...
      <div className="absolute right-0 top-full z-50 mt-1 w-[320px] rounded-lg border border-[#e0e0e0] bg-white py-1.5 shadow-[0_4px_16px_rgba(0,0,0,0.12)]">
        <button className="flex w-full items-center gap-3 px-4 py-3 text-left hover:bg-[#f5f5f5]">
          <ToolsExtensionsIcon />
          <div className="flex flex-col">
            <span className="text-[14px] font-medium text-[#1d1f25]">Extensions</span>
            <span className="text-[12px] text-[#888]">Extend the functionality of your base</span>
          </div>
        </button>
        <div className="mx-3 border-t border-[#e8e8e8]" />
        <button className="flex w-full items-center gap-3 px-4 py-3 text-left hover:bg-[#f5f5f5]">
          ...
          <div className="flex flex-col">
            <span className="text-[14px] font-medium text-[#1d1f25]">Manage fields</span>
            <span className="text-[12px] text-[#888]">Edit fields and inspect dependencies</span>
          </div>
        </button>
        <div className="mx-3 border-t border-[#e8e8e8]" />
        <button className="flex w-full items-center gap-3 px-4 py-3 text-left hover:bg-[#f5f5f5]">
          <ToolsDocIcon />
          <div className="flex flex-col">
            <span className="text-[14px] font-medium text-[#1d1f25]">Record templates</span>
            <span className="text-[12px] text-[#888]">Create records from a template</span>
          </div>
        </button>
        <div className="mx-3 border-t border-[#e8e8e8]" />
        <button className="flex w-full items-center gap-3 px-4 py-3 text-left hover:bg-[#f5f5f5]">
          <ToolsSwapIcon />
          <div className="flex flex-col">
            <span className="text-[14px] font-medium text-[#1d1f25]">Date dependencies</span>
            <span className="text-[12px] text-[#888]">Configure date shifting between dependent records</span>
          </div>
        </button>
        <div className="mx-3 border-t border-[#e8e8e8]" />
        <button className="flex w-full items-center gap-3 px-4 py-3 text-left hover:bg-[#f5f5f5]">
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-1.5">
              <span className="text-[14px] font-medium text-[#1d1f25]">Insights</span>
              <ToolsBusinessBadge />
            </div>
            <span className="text-[12px] text-[#888]">Understand and improve base health</span>
          </div>
        </button>
      </div>
    </>
...
export function Toolbar({
  ...
  const [openPanel, setOpenPanel]     = useState<"filter" | "sort" | "hide" | "gridView" | "group" | "color" | "rowHeight" | "shareSync" | "tools" | null>(null);
  ...
  // Sync incoming search prop to local (e.g. view switch), but don't close the bar
  useEffect(() => {
  ...
  return (
    <div className="relative flex-shrink-0 border-b border-black/10 bg-white">
          ...
          <div className="relative">
            <button
              className={`flex items-center rounded p-1.5 transition-colors ${
                openPanel === "rowHeight" ? "bg-[#d0e5ff] text-[#2d7ff9]" : "text-[#666] hover:bg-[#f0f0f0]"
              }`}
      ...
      {searchOpen && (
        <div className="absolute right-2 top-full z-40 mt-0.5 flex w-[380px] items-center gap-1.5 rounded-lg border border-[#ddd] bg-white px-3 py-1.5 shadow-[0_4px_12px_rgba(0,0,0,0.1)]">
          <input
            ref={inputRef}
            value={localSearch}
            ...
            onKeyDown={(e) => {
              ...
              if (e.key === "Enter") {
                if (e.shiftKey) onSearchIndexChange(Math.max(1, searchIndex - 1));
                else if (matchCount) onSearchIndexChange(searchIndex < matchCount ? searchIndex + 1 : 1);
              }
            }}
          ...
          {/* Match count / loading */}
          {localSearch.trim() && (
            <span className="flex shrink-0 items-center gap-1 whitespace-nowrap text-[12px] tabular-nums text-[#888]">
              {isSearching ? (
          ...
          <button
            onClick={() => { if (matchCount) onSearchIndexChange(searchIndex < matchCount ? searchIndex + 1 : 1); }}
            className="shrink-0 rounded p-0.5 text-[#888] hover:bg-[#f0f0f0] hover:text-[#444]"
          >
  ...
  return (
    <button
      ...
      className={`relative flex items-center gap-1.5 rounded px-2 py-1.5 text-[13px] transition-colors ${
        active ? "bg-[#d0e5ff] text-[#2d7ff9]" : "text-[#1d1f25]/80 hover:bg-black/5"
      }`}
    >
